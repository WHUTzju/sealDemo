...
//    private static String password = "123456";
    ...
    private final static String issuerStr = "CN=飞洛印,OU=飞洛印,O=杭州趣链有限公司,C=CN,E=filoink@cn.hyperchain.cn,L=杭州,ST=杭州";
    private final static String subjectStr = "CN=飞洛印,OU=飞洛印,O=杭州趣链有限公司,C=CN,E=filoink@cn.hyperchain.cn,L=杭州,ST=杭州";
