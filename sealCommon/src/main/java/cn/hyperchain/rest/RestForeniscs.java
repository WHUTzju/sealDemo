...
//    private final static String BASE_URL = "http://127.0.0.1:8080";
    private final static String BASE_URL = "https://api.filoink.cn/open-forensics/v3/forensics/web";
...
//        getResult("filoink-open", "20220906359300bec");
        ...
        String token = getToken("6fc08efe-230a-4c7b-bc69-bf44e22f0655", "b768c8a0-4a94-4228-9995-7491b486e455");
...
//                    , String.class, paramMap);
    ...
    public static String getToken(String appKey, String appSecret) {
        ...
        try {
            ...
            ResponseEntity<String> responseEntity = restTemplate.postForEntity(
                    "https://api.filoink.cn/open-forensics/v3/token", httpEntity, String.class);
            res = responseEntity.getBody();
